    ...
    data: [
      {
        ...
        sampleName: "Хлеб пшеничный, партия №1234",
        batchNumber: "1234",
        supplier: "Собственное производство",
        result: "compliant",
        details: "КМАФАнМ: 1.2×10³ КОЕ/г (норма до 1×10⁴). Патогенные микроорганизмы не обнаружены.",
        createdById: technologist.id,
        signedAt: daysAgo(3),
      },
      {
        ...
        sampleName: "Мука пшеничная высший сорт",
        batchNumber: "5678",
        supplier: "ООО 'Мукомол'",
        result: "compliant",
        details: "Влажность: 13.5% (норма до 14.5%). Клейковина: 28% (норма 23-40%). Зольность: 0.55% (норма до 0.55%).",
        createdById: technologist.id,
        signedAt: daysAgo(5),
      },
      {
        date: daysAgo(7),
        testType: "Микробиология",
        sampleName: "Молоко коровье пастеризованное",
        batchNumber: "9012",
        supplier: "ИП Молочников",
        result: "deviation",
        details: "Обнаружено превышение КМАФАнМ: 5×10⁵ КОЕ/г (норма до 1×10⁵). Партия забракована.",
        createdById: technologist.id,
        signedAt: daysAgo(7),
      ...
      },
      {
        ...
        sampleName: "Хлеб бородинский",
        batchNumber: "3456",
        supplier: "Собственное производство",
        result: "compliant",
        details: "Масса: 500±10г. Влажность мякиша: 45% (норма 43-48%). Кислотность: 7° (норма до 12°).",
        createdById: technologist.id,
        signedAt: daysAgo(10),
      },
      {
        ...
        sampleName: "Торт 'Наполеон'",
        batchNumber: "7890",
        supplier: "Собственное производство",
        result: "compliant",
        details: "Внешний вид: правильная форма, без деформаций. Вкус и запах: свойственные данному виду изделия. Цвет: равномерный.",
        createdById: technologist.id,
        signedAt: daysAgo(2),
      },
      {
        date: daysAgo(1),
        testType: "Микробиология",
        sampleName: "Смывы с оборудования (печь №1)",
        batchNumber: "СМЫВ-001",
        supplier: null,
        result: "compliant",
        details: "БГКП не обнаружены. S.aureus не обнаружен. Санитарное состояние удовлетворительное.",
        createdById: technologist.id,
        signedAt: daysAgo(1),
      },
    ],
